...
func main() {
	// single cert
	creds, err := credentials.NewClientTLSFromFile("E:/gopath/src/github.com/suchongming/grpctest/single-cert/ca.crt",
		"peer0.org3.example.com")

	// double cert
	//creds, err := credentials.NewClientTLSFromFile("E:/gopath/src/github.com/suchongming/grpctest/double-cert/server_ca.crt",
